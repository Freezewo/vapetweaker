...
local getcustomassets = {
	['vapetweaker/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['vapetweaker/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['vapetweaker/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['vapetweaker/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['vapetweaker/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['vapetweaker/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['vapetweaker/assets/old/info.png'] = 'rbxasset://info.png',
	['vapetweaker/assets/old/pin.png'] = 'rbxasset://pin.png',
	['vapetweaker/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['vapetweaker/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['vapetweaker/assets/old/search.png'] = 'rbxasset://search.png',
	['vapetweaker/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['vapetweaker/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['vapetweaker/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['vapetweaker/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['vapetweaker/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['vapetweaker/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['vapetweaker/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['vapetweaker/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
components = {
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('vapetweaker/assets/old/checkbox.png')
	...
	Toggle = function(optionsettings, children, api)
		...
		toggle.Text = string.rep('вЂЉ', 32)..optionsettings.Name
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('vapetweaker/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('vapetweaker/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('vapetweaker/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('vapetweaker/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('vapetweaker/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('vapetweaker/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('vapetweaker/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('vapetweaker/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('vapetweaker/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('vapetweaker/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('vapetweaker/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('vapetweaker/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('vapetweaker/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('vapetweaker/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('vapetweaker/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('vapetweaker/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('vapetweaker/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('vapetweaker/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('vapetweaker/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('vapetweaker/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('vapetweaker/assets/old/textv4.png')
