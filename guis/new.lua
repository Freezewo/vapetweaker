...
components = {
	...
	Dropdown = function(optionsettings, children, api)
		...
		title.BackgroundTransparency = 1
		title.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..optionsettings.Name..' - '..optionapi.Value
		title.TextXAlignment = Enum.TextXAlignment.Left
		title.TextColor3 = color.Dark(uipallet.Text, 0.16)
		title.TextSize = 13
		...
		function optionapi:SetValue(val, mouse)
			...
			title.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..optionsettings.Name..' - '..self.Value
		...
		button.MouseButton1Click:Connect(function()
			if not dropdownchildren then
				...
				for _, v in optionsettings.List do
					...
					dropdownoption.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..v
	...
	Toggle = function(optionsettings, children, api)
		...
		toggle.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..optionsettings.Name
	...
	Divider = function(children, text)
		...
		if text then
			...
			label.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..text:upper()
...
function mainapi:CreateGUI()
	...
	function categoryapi:CreateBind()
		...
		button.BorderSizePixel = 0
		button.AutoButtonColor = false
		button.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉRebind GUI'
	...
	function categoryapi:CreateButton(categorysettings)
		...
		button.BorderSizePixel = 0
		button.AutoButtonColor = false
		button.Text = (categorysettings.Icon and 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ' or 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ')..categorysettings.Name
		button.TextXAlignment = Enum.TextXAlignment.Left
		button.TextColor3 = color.Dark(uipallet.Text, 0.16)
		button.TextSize = 14
		button.FontFace = uipallet.Font
	...
	function categoryapi:CreateOverlayBar()
		...
		function optionapi:CreateToggle(togglesettings)
			...
			toggle.AutoButtonColor = false
			toggle.Text = string.rep('вЂЉ', 33 * scale.Scale)..togglesettings.Name
			toggle.TextXAlignment = Enum.TextXAlignment.Left
			toggle.TextColor3 = color.Dark(uipallet.Text, 0.16)
			toggle.TextSize = 14
			toggle.FontFace = uipallet.Font
	...
	function categoryapi:CreateSettingsPane(categorysettings)
		...
		button.BorderSizePixel = 0
		button.AutoButtonColor = false
		button.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..categorysettings.Name
		button.TextXAlignment = Enum.TextXAlignment.Left
		button.TextColor3 = color.Dark(uipallet.Text, 0.16)
		button.TextSize = 14
		button.FontFace = uipallet.Font
		...
		windowlist:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
			...
			for _, v in categoryapi.Buttons do
				if v.Icon then
					v.Object.Text = string.rep('вЂЉ', 33 * scale.Scale)..v.Name
				end
			end
		end)
	...
	windowlist:GetPropertyChangedSignal('AbsoluteContentSize'):Connect(function()
		...
		for _, v in categoryapi.Buttons do
			if v.Icon then
				v.Object.Text = string.rep('вЂЉ', 36 * scale.Scale)..v.Name
			end
		end
	end)
...
function mainapi:CreateCategory(categorysettings)
	...
	function categoryapi:CreateModule(modulesettings)
		...
		modulebutton.Text = 'вЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉвЂЉ'..({modulesettings.Name:gsub(' ', '')})[1]
...
Profiles:CreateButton({
	...
	Function = function()
		...
		if shared.VapeDeveloper then
			loadstring(readfile('vapetweaker/loader.lua'), 'loader')(shared.catdata)
		else
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Freezewo/vapetweaker/'..readfile('vapetweaker/profiles/commit.txt')..'/loader.lua', true))(shared.catdata)
		end
	end
})
...
general:CreateButton({
	...
	Function = function()
		shared.vapereload = true
		if shared.VapeDeveloper then
			loadstring(readfile('vapetweaker/init.lua'), 'init')(shared.catdata)
		else
			loadstring(game:HttpGet('https://raw.githubusercontent.com/Freezewo/vapetweaker/'..readfile('vapetweaker/profiles/commit.txt')..'/loader.lua', true))(shared.catdata)
		end
	end,
